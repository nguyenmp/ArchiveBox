...
class YtdlpConfig(BaseConfigSet):
    ...
    YTDLP_EXTRA_ARGS: List[str]   = Field(default=["--write-description", "--skip-download", "--write-subs", "--cache-dir=/data/yt-dlp-cache/", "--username=oauth2", "--password=", "--proxy=socks5://tor-socks-proxy:9150", "--write-info-json"], alias='YOUTUBEDL_EXTRA_ARGS')
